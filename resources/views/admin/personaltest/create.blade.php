                        ...
                        <div class="col-md-12  ">
                            <div class="card ">
                                <div class="card-header text-center">
                                    <h4 class="card-title text-center" id="basic-layout-form">  add personal test  </h4>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="" id="cost" class="form-control"
                                                    name="cost">
                                                @error('cost')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="" id="addedBy" class="form-control"
                                                    value="" name="addedBy">
                                                @error('addedBy')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
